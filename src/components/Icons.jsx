...
export const TruckIcon = ({ className = "w-5 h-5", ...props }) => (
  ...
  >
    ...
    <path d="M16 8h4l3 3v5h-7V8ZM12 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM6 18a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" />
  </svg>
);

export const ShieldCheckIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const ChevronUpIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const WhatsAppIcon = ({ className = "w-5 h-5", ...props }) => (
  <svg
    ...
    {...props}
  >
    <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.717-1.458L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.965C16.528 1.977 14.072 1.05 11.448 1.05c-5.442 0-9.868 4.372-9.872 9.802-.001 1.772.477 3.5 1.385 5.006l-1.01 3.691 3.79-.974c1.472.8 3.018 1.22 4.595 1.22l.311-.001zm10.743-7.234c-.29-.144-1.716-.836-1.982-.931-.266-.094-.46-.144-.654.144-.194.288-.752.937-.922 1.13-.17.194-.34.216-.63.072-.29-.144-1.227-.446-2.336-1.423-.864-.759-1.448-1.7-1.617-1.987-.17-.29-.018-.446.126-.59.13-.13.29-.336.435-.5.144-.165.194-.28.29-.468.096-.188.048-.352-.024-.497-.072-.145-.654-1.547-.895-2.115-.236-.56-.474-.485-.654-.494-.17-.008-.363-.01-.556-.01-.194 0-.508.072-.774.36-.266.288-1.016.979-1.016 2.388 0 1.41 1.04 2.77 1.185 2.964.144.194 2.046 3.087 4.956 4.321.692.293 1.233.468 1.656.6.696.218 1.33.187 1.83.113.557-.082 1.716-.69 1.958-1.357.242-.668.242-1.24.17-1.357-.072-.116-.266-.194-.556-.34z" />
  </svg>
);
